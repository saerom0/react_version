...
function SignUp() {
	...
	const [starIcon] = useState(
		<FontAwesomeIcon icon={faStarOfLife} className='starIcon' />
	);
			...
			<form action='' onSubmit={handleSubmit}>
				<fieldset>
					...
					<div className='must'>
						...
						></textarea>
						<div className='agree'>
							<label htmlFor='mustAgree'>이용약관에 동의합니다.</label>
							<input type='checkbox' name='allAgree' id='mustAgree' required />
						</div>
					</div>
					<div className='choice'>
						...
						<div className='agree'>
							...
							<input type='checkbox' name='allAgree' id='choiceAgree' />
						</div>
					</div>
					<h2>회원가입 작성 정보</h2>
					<table>
						<tbody>
							{/* MEMBER TYPE */}
							<tr>
								<th scope='row'>MEMBER TYPE{starIcon}</th>
								<td>
									<input
										type='radio'
										name='type'
							...
							{/* gender */}
							<tr>
								<th scope='row'>GENDER{starIcon}</th>
								<td>
									<input
										type='radio'
										name='gender'
							...
							<tr>
								...
								<td>
									<select name='selectNum' id='phone' onChange={handleSelect}>
